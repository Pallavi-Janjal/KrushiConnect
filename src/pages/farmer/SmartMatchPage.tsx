                ...
                <div key={item.id} className="bg-white rounded-2xl border border-slate-200/80 p-5 shadow-xs hover:shadow-md transition-all space-y-4 relative overflow-hidden">
                  ...
                  <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                    ...
                    <div className="flex items-center gap-4 min-w-0 flex-1">
                      <div className="relative w-24 sm:w-28 h-24 sm:h-28 rounded-xl overflow-hidden bg-slate-100 shrink-0 border border-slate-200/80">
                        <img
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <h3 className="font-bold text-slate-900 text-base mt-1.5 truncate">{item.name}</h3>
                        <div className="flex items-center gap-3 text-xs text-slate-500 mt-1 flex-wrap">
                          <RatingStars rating={item.rating} reviewCount={item.reviewCount} size={14} />
                          <span className="flex items-center gap-1 font-semibold text-slate-700">
                            <Zap className="w-3 h-3 text-amber-500 fill-amber-400" /> {item.hp} {t('common.hp')}
                          </span>
                          <span className="flex items-center gap-1 text-[#166534] font-semibold truncate">
                            <MapPin className="w-3 h-3 text-[#166534] shrink-0" /> {item.location}
                          </span>
                        </div>
                      </div>
                    </div>

                    <div className="text-right sm:self-center shrink-0 w-full sm:w-auto flex sm:flex-col items-center sm:items-end justify-between sm:justify-center border-t sm:border-t-0 pt-2 sm:pt-0 border-slate-100">
                      <div>
                      ...
                      <button
                        ...
                        className="sm:mt-2 px-4 py-2 rounded-xl bg-[#166534] hover:bg-[#004C22] text-white text-xs font-bold shadow-xs hover:shadow-md transition-all flex items-center gap-1 cursor-pointer whitespace-nowrap"
                      >
                  ...
                  {/* Match Reasons List */}
                  <div className="bg-gradient-to-br from-emerald-50/80 to-lime-50/50 border border-emerald-200/70 rounded-xl p-3 text-xs space-y-1.5">
                    <div className="font-bold text-[#166534] text-[11px] uppercase tracking-wider flex items-center gap-1">
                      <Sparkles className="w-3.5 h-3.5 text-amber-500" />
                      <span>{t('smart.whyMatch')}</span>
                    </div>
